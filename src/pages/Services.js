    ...
    // },
     {
      ...
      image: 'https://images.unsplash.com/photo-1576671414121-aa0c81c869e1',
      icon: 'fas fa-magnet',
      description: 'Echocardiography (ECHO) uses sound waves to produce images of the heart and its structures.',
      details: [
        'AdultECHO',
        'Doppler ECHO',
        'Fetal ECHO'
      ],
      benefits: 'ECHO provides detailed images without using radiation and is particularly useful for examining soft tissues, the heart, and the surrounding structures.',
      duration: '30-60 minutes'
    },
 {
      id: 'ECG',
      ...
      description: 'Electrocardiogram (ECG) is a test that records the electrical activity of the heart over a period of time. Reporting done by AI as well as experienced physicians.',
      details: [
        'Chest ECG',
      ],
      benefits: 'ECG tests can quickly identify internal injuries and diseases. They are particularly useful in emergency situations and for diagnosing complex conditions.',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Our team consists of experienced radiologists, doctors, nurses and technicians who are committed to providing the highest quality care.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                We use state-of-the-art imaging equipment to ensure accurate and reliable results with help of best machines & AI.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                We understand the importance of timely results and strive to provide reports as quickly as possible within 10 minutes.
              </p>
            </div>
       ...
       <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
          <div className="w-12 h-12 bg-yana-orange bg-opacity-10 rounded-full flex items-center justify-center mb-4">
           <i className="fas fa-clock text-yana-orange text-xl"></i>
             ...
             <h3 className="text-xl font-semibold text-gray-800 mb-2">Before & After Work</h3>
             <p className="text-gray-600">
              Open 8 AM to 10 PM, we accommodate your schedule with flexible hours best for working professionals.
                </p>
        </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                  <div className="w-12 h-12 bg-yana-orange bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                     <i className="fas fa-vials text-yana-orange text-xl"></i>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">All Lab Tests</h3>
                <p className="text-gray-600">
    We offer a comprehensive range of lab tests to meet all your diagnostic needs.
  </p>
</div>
