...
const Home = () => {
  ...
  `}
      ...
      {/* Hero Section
      <section className="hero-section relative flex items-center min-h-screen bg-opacity-60 bg-cover bg-center" 
      style={{
  backgroundImage: `linear-gradient(135deg, #e0f7fa 0%, #e0ffe0 100%)`
}}>

        <div className="absolute inset-0 bg-black opacity-40"></div>
        <div className="container mx-auto px-6 relative z-10 pt-32">
          <div className="max-w-3xl text-center mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-poppins"  style={{
    ...
    opacity: 0,
      ...
      {/* Hero Section */}
<section
  className="hero-section relative flex items-center min-h-screen bg-gradient-animated bg-cover bg-center"
