...
<nav className={`fixed w-full z-50 transition-all duration-300 ease-in-out ${
  scrolled ? 'bg-white shadow-lg text-gray-900' 
           : 'bg-[#fdfdfd] bg-opacity-95 text-gray-900'
}`}>
        ...
        <div className="flex justify-between h-20">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className={`inline-flex items-center justify-center p-2 rounded-md ${scrolled ? 'text-yana-orange-dark' : 'text-[#4F23A9]'}`}
              aria-expanded="false"
            >
...
<Link
  to={to}
  className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-all duration-300 ease-in-out ${
    isActive 
      ? 'border-yana-orange text-yana-orange' 
      : `${scrolled 
          ? 'border-transparent text-gray-600 hover:text-yana-orange-dark' 
          : 'border-transparent text-[#4F23A9] hover:text-yana-orange-light'}`
  }`}
>
  ...
  return (
    <Link
      ...
      className={`block px-3 py-2 rounded-md text-base font-medium ${
        isActive 
          ? 'bg-yana-orange-light text-[#4F23A9]' 
