          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="h-96 bg-gray-200 rounded-lg overflow-hidden shadow-md">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d340.44451978029514!2d77.63764728297976!3d12.90867292326924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae148e105fe55b%3A0xcf866b7689f4e259!2sGail%20Gas%20Limited%20HSR!5e0!3m2!1sen!2sin!4v1751903177258!5m2!1sen!2sin" 
                  width="100%"
                  height="100%"
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2">
                  <li className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">8:00 AM - 10:00 PM</span>
                  </li>
                  <li className="flex justify-between">
                  ...
                  <li className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">10:00 AM - 10:00 PM</span>
                  </li>
                </ul>
              </div>
            </div>
